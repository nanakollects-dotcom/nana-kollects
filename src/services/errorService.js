const SAFE_MESSAGE_BY_EXACT_TEXT = new Map([
  ...
  ["payment request document has no items.", "This Payment Request has no item snapshots. Refresh and try again."],
  ["payment request document has too many items.", "This Payment Request exceeds the supported 50-item document limit."],
  ["payment request document item snapshots are invalid.", "This Payment Request has invalid item snapshots. Refresh and try again."],
  ["payment request document totals are invalid.", "This Payment Request has inconsistent totals. Refresh and try again."],
  ["this payment request has too many items for one image. download the pdf instead.", "This Payment Request is too large for one image. Download the PDF instead."],
