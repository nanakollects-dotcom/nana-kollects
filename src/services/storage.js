...
export function normalizeStore(rawStore = {}) {
  ...
  return {
    ...
    saleHeaders: Array.isArray(rawStore.saleHeaders) ? rawStore.saleHeaders : [],
    saleItems: Array.isArray(rawStore.saleItems) ? rawStore.saleItems : [],
    paymentRequests: Array.isArray(rawStore.paymentRequests) ? rawStore.paymentRequests : [],
    paymentRequestItems: Array.isArray(rawStore.paymentRequestItems) ? rawStore.paymentRequestItems : [],
    inventoryReservations: Array.isArray(rawStore.inventoryReservations) ? rawStore.inventoryReservations : [],
